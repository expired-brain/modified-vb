...
*
* @package	vBulletin
* @version	$Revision: 80813 $
* @date		$Date: 2014-05-24 04:44:36 -0700 (Sat, 24 May 2014) $
*/
class vB_Bitfield_Builder
{
	...
	*/
	static function build_datastore()
	{
		...
		else if (self::build(false) === false)
		{
			return false;
		}
	...
	*/
	static function fetch_permission_group($permgroup)
	{
		...
		if (self::build(false) === false)
		{
			echo "<strong>error</strong>\n";
			print_r(self::fetch_errors());
			return $output;
		}
