...
*
* @package 		vBulletin
* @version		$Revision: 83871 $
* @author		Kier & Mike
* @date 		$Date: 2015-01-25 14:56:41 -0800 (Sun, 25 Jan 2015) $
...
class vBulletinHook
{
	...
	* @return	string
	*/
	static function fetch_hook($hookname = false)
	{
		if (!$hookname)
		{
			return false;
	...
	*/
	static function build_datastore(&$dbobject)
	{
		$code = array();
		$admincode = array();
	...
	*/
	static function fetch_hookusage()
	{
		$obj =& vBulletinHook::init();
