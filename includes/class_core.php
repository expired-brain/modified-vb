...
define('FILE_VERSION', '3.8.9'); // this should match install.php
define('SIMPLE_VERSION', '389'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 84924 $
* @date		$Date: 2015-06-11 18:41:41 -0700 (Thu, 11 Jun 2015) $
*/
class vB_Database
{
	/**
