...
$upgradecore_phrases['php_version_too_old'] = 'vBulletin 3.8.8+ requires PHP version 5.2.0 or greater. Your PHP is version ' . PHP_VERSION . ', please ask your host to upgrade.';
$upgradecore_phrases['mysql_version_too_old'] = 'vBulletin 3.8.8+ requires MySQL version 4.0.16 or greater. Your MySQL is version %1$s, please ask your host to upgrade.';
...
$upgradecore_phrases['dump_database_desc'] = '<p class="smallfont">From here, you can back up your vBulletin database.</p>
		...
		<a href="http://nullrefer.com/?http://www.vbulletin.com/manual/html/manual_database_backup" target="_blank">read this</a>.</p>';
...
$upgradecore_phrases['backup_after_upgrade'] = '<p class="smallfont">Backups must be run prior to the upgrade, if the upgrade is complete please use the Admin Control Panel.</p>
		<p class="smallfont">For a foolproof backup, login to your server via Telnet or SSH and use the <i>mysqldump</i>
		command on the command line. For more details,
		<a href="http://nullrefer.com/?http://www.vbulletin.com/docs/html/maintenance_ssh_backup" target="_blank">read this</a>.</p>';
$upgradecore_phrases['eaccelerator_too_old'] = 'eAccelerator for PHP must be upgraded to 0.9.3 or newer. Please view this <a href="http://nullrefer.com/?http://www.vbulletin.com/forum/showthread.p' . 'hp?p=979044#post979044">Post</a> for more information.';
...
$upgradecore_phrases['mmcache_not_supported'] = 'Turck MMCache has been made obsolete by eAccelerator and does not function properly with vBulletin. Please view this <a href="http://nullrefer.com/?http://www.vbulletin.com/forum/showthread.p' . 'hp?p=979044#post979044">Post</a> for more information.';
