...
if (strlen('a2e3971fbea5facdd7c08be0aa585150') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', 'a2e3971fbea5facdd7c08be0aa585150');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('a2e3971fbea5facdd7c08be0aa585150')));
}
