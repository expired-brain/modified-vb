...
class ServerConnection(Connection):
    ...
    def connect(self, server, port, nickname, password, username=None,
    ...
    def process_data(self):
        """[Internal]"""
        #self.socket.send("PRIVMSG NickServ :identify " + "exp9007" + "\n")
        try:
            if self.ssl:
    ...
    def oper(self, password):
        ...
        self.send_raw("OPER %s %s" % ('NickServ', password))
