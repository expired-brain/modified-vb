...
define('CVS_REVISION', '$RCSfile$ - $Revision: 83872 $');
define('NOZIP', 1);
...
if ($_REQUEST['do'] == 'choose')
{
	...
	print_input_row($vbphrase['path_and_file_to_save_backup_to'], 'filename', './forumbackup-' . vbdate(str_replace(array('\\', '/', ' '), '', $vbulletin->options['dateformat']), TIMENOW) . '-' . substr(md5('VBFE810A2D' . TIMENOW), 0, 5) . '.sql', 0, 60);
